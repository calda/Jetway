...
public enum HTTP {
    ...
    // MARK: - HTTP.StatusCode

    /// This is a list of Hypertext Transfer Protocol (HTTP) response status codes.
    /// It includes codes from IETF internet standards, other IETF RFCs, other specifications, and some additional commonly used codes.
    /// The first digit of the status code specifies one of five classes of response; an HTTP client must recognise these five classes at a minimum.
    /// Based on https://gist.github.com/ollieatkinson/322338df8a5220d649ac01ff11e7de12
    public enum StatusCode: Int, LocalizedError, CustomStringConvertible {
        ...
        /// An unknown or unhandled HTTP error code
        case unknown = -1
        ...
        /// The numerical code representing this error
        public var code: Int {
            return rawValue
        }
        ...
        public var name: String {
            ...
            case .permenantRedirect: return "Permenant Redirect"
            ...
            case .HTTPRequestSentToHTTPSPort: return "HTTP Request Sent To HTTPS Port"
...
// MARK: - Foundation + HTTP types

extension URLRequest {
    
    var method: HTTP.Method? {
        get {
            guard let methodString = httpMethod,
                let method = HTTP.Method(rawValue: methodString) else
            {
                return nil
            }
...
extension HTTPURLResponse {
    var httpStatusCode: HTTP.StatusCode {
        return HTTP.StatusCode(rawValue: self.statusCode) ?? .unknown
    }
}
